...
PROGRESS_COLLECTION = config.PROGRESS_COLLECTION  # "progress" in Mongo carddb
...
def init_system():
    """Initializes the Mongo collection and local directory."""
    os.makedirs(BASE_LOCAL_PATH, exist_ok=True)
    progress_coll().create_index([("image_name", 1), ("game_name", 1), ("language", 1)])
    # Record this script's last run into Mongo run_history
